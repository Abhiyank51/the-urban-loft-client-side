...
// revalidate or refresh cache data daily 
export const revalidate = 86400; // secnds in a day 60*60*24
    ...
    <div className="grid grid-cols-5 gap-x-24 gap-y-32 text-lg items-center">
      <div className="col-span-3">
        <h1 className="text-4xl mb-10 text-accent-400 font-medium">
          Welcome to The Urban Loft Cabins
        </h1>
        ...
        <div className="space-y-8">
          ...
          <p>
            Our {totalCabins.length} luxury cabins provide a cozy base, but the real freedom and
      ...
      <div className="col-span-2">
        <Image src={about2} placeholder="blur" alt="Family that manages The Urban Loft Cabins" />
      </div>
      ...
      <div className="col-span-3">
        ...
        <div className="space-y-8">
          <p>
            Since 1962, The Urban Loft Cabins has been a cherished family-run retreat.
            Started by our grandparents, this haven has been nurtured with love
            and care, passing down through our family as a testament to our
            dedication to creating a warm, welcoming environment.
          </p>
          <p>
            Over the years, we&apos;ve maintained the essence of The Urban Loft Cabins,
